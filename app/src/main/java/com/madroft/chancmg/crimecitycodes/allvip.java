 ...
 */
public class allvip extends Activity implements AdapterView.OnItemClickListener {
    // JSON Node names
    private static final String TAG_SUCCESS = "success";
    private static final String REGISTER_URL = "http://madroft.16mb.com/android_connect/getallvip.php";
    ...
    private class RegisterUser extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            loading = ProgressDialog.show(allvip.this, "Please Wait", null, true, true);
